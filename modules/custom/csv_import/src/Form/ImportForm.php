...
class ImportForm extends FormBase {
    ...
    public function submitForm(array &$form, FormStateInterface $form_state) {
        ...
        switch ($import_type) {
            case 'negativeDeclaration':
                ...
                ImportForm::batchImportData($import, 'csv_import.inc.php');
                break;
                
            case 'biweeklyCaseFiling':
                $import = new ImportBiweeklyCaseController();
                ImportForm::batchImportData($import, 'csv_import_biweekly.inc.php');
                break;
            
            case 'overlays':
                $import = new ImportOverlayController();
                ImportForm::batchImportData($import, 'csv_import_overlay.inc.php');
                break;
    ...
    static function batchImportData ( $import, $import_file ) {
        ...
        $batch = array(
                ...
                'file' => drupal_get_path('module', 'csv_import'). '/'.$import_file,
        );
