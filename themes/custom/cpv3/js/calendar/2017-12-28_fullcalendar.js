...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (seg.isStart) {
			...
			if (timeText) {
				timeHtml = iconFontClass + ' <span class="fc-time">' + htmlEscape(timeText) + '</span>';
			}
		}

		return '<a class="' + classes.join(' ') + '"' +
				(event.url ?
					' href="' + htmlEscape(calEventUrl) + '"' :
					''
					) +
				(skinCss ?
					' style="' + skinCss + '"' :
			...
			' target="_blank">' +
				'<div class="fc-content '+ titleColor +'">' +
					(this.isRTL ?
...
function getCPCName (name) {
	var cpcName;
	switch (name) {
		case 'Cultural Heritage Commission' :
			cpcName = 'culturalheritagecommission';
			break;
		case 'North Valley' :
			cpcName = 'northvalley';
			break;
		...
		case 'West Los Angeles' :
			cpcName = 'westlosangeles';
			break;
		case 'Central Los Angeles' :
			cpcName = 'centrallosangeles';
			break;
		case 'East Los Angeles' :
			cpcName = 'eastlosangeles';
			break;
		case 'South Los Angeles' :
			cpcName = 'southlosangeles';
			break;
		case 'Harbor' :
			cpcName = 'harbor';
			break;
