...
(function (factory) {
  ...
  OrgChart.prototype = {
    ...
    createNode(nodeData, level, opts) {
      ...
      // custom for level color
      var level_class = 'level'+level;
      var content_border = 'level'+level+'_border';
      ...
      if (opts.nodeTemplate) {
        ...
        $nodeDiv.append('<div class="title '+level_class+'">' + nodeData[opts.nodeTitle] + '</div>')
          .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content '+content_border+'">' + (nodeData[opts.nodeContent] || '') + '</div>' : '');
      }
