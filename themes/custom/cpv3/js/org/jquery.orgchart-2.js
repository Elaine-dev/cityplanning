  ...
  OrgChart.prototype = {
    ...
    createNode: function (data) {
      ...
      if (opts.nodeTemplate) {
        ...
        $nodeDiv.append('<div class="title '+level_class+'">' + data[opts.nodeTitle] + '</div>')
          .append(typeof opts.nodeContent !== 'undefined' ? '<div class="content '+content_border+'">' + (data[opts.nodeContent] || '') + '</div>' : '');
      }
