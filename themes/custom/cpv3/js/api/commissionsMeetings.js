var appCommMeetings = angular.module('appCommMeetings', ['ngSanitize', 'ngRoute', 'ngAnimate', 'ui.bootstrap'])
	...
	.controller('commissionCtrl', ['$scope', '$sce', 'commissionService', '$filter', '$timeout', function($scope, $sce, commissionService, $filter, $timeout) {
		$scope.apcAreas = {
		   availableOptions: [ 
	...
	// Board Controller
	.controller('boardCtrl', ['$scope', '$sce', 'boardService', '$filter','$timeout', function($scope, $sce, boardService, $filter, $timeout) {
			$scope.apcAreas = {
				availableOptions: [ 
					{id: 'northvalley', name: 'North Valley' },
					{id: 'southvalley', name: 'South Valley'},
	...
	// Hearings Controller
	.controller('hearingsCtrl', ['$scope', '$sce', 'hearingsService', '$filter','$timeout', function($scope, $sce, hearingsService, $filter, $timeout) {
			$scope.apcAreas = {
				availableOptions: [ 
					{id: 'northvalley', name: 'North Valley' },
					{id: 'southvalley', name: 'South Valley'},
