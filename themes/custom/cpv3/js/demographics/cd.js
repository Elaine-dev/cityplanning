...
require([
    ...
    var SHAPE = new FeatureLayer("https://services1.arcgis.com/tzwalEyxl2rpamKs/ArcGIS/rest/services/ACS_2016_Council_Districts/FeatureServer/0", {
    ...
    SHAPE.on("mouse-over", function (evt) {
        var t = "<b>Council District ${plngdb01_MNT_COUNCIL_DST_PLY_DI}</b>";

        var content = esriLang.substitute(evt.graphic.attributes, t);
        var highlightGraphic = new Graphic(evt.graphic.geometry, highlightSymbol, evt.graphic.attributes);
        map.graphics.add(highlightGraphic);

        Area_Planning_Commission_APC_Na = evt.graphic.attributes.plngdb01_MNT_COUNCIL_DST_PLY_DI;
        Owner_Households = evt.graphic.attributes.Demographics_Comparison___Cou_1;
        Renter_Households = evt.graphic.attributes.Demographics_Comparison___Cou_2;
        Below_Poverty = evt.graphic.attributes.Demographics_Comparison___Cou_3;
        At_Above_Poverty = evt.graphic.attributes.Demographics_Comparison___Cou_4;
        Households = evt.graphic.attributes.Demographics_Comparison___Cou_5;
        Households_with_2_People = evt.graphic.attributes.Demographics_Comparison___Cou_6;
        Households_with_3_People = evt.graphic.attributes.Demographics_Comparison___Cou_7;
        Households_with_4_People = evt.graphic.attributes.Demographics_Comparison___Cou_8;
        Households_with_5_People = evt.graphic.attributes.Demographics_Comparison___Cou_9;
    ...
    function sendToChart() {
        ...
        $("h5").html('Council District '+Area_Planning_Commission_APC_Na);
        ...
        load_own_rent_bar(data, "own_rent_bar-cd");
        ...
        load_donut(data, "poverty_donut-cd");
        ...
        data["labels"] = ["Enrolled in Kindergarten",
         ...
         load_donut(data, "education_donut-cd");		  
         ...
         load_donut(data, "household_donut-cd");
    }
