...
require([
    ...
    var SHAPE = new FeatureLayer("https://services1.arcgis.com/tzwalEyxl2rpamKs/arcgis/rest/services/ACS_2016_Area_Planning_Commissions_APC/FeatureServer/0", {
...
/**    if (dialog) {
    ...
    SHAPE.on("mouse-over", function (evt) {
        var t = "<b>${Area_Planning_Commission_APC_Na}</b>";

        var content = esriLang.substitute(evt.graphic.attributes, t);
        var highlightGraphic = new Graphic(evt.graphic.geometry, highlightSymbol, evt.graphic.attributes);
        map.graphics.add(highlightGraphic);

        Area_Planning_Commission_APC_Na = evt.graphic.attributes.Area_Planning_Commission_APC_Na;
        Owner_Households = evt.graphic.attributes.Demographics_Comparison__APC__1;
        Renter_Households = evt.graphic.attributes.Demographics_Comparison__APC__2;
        Below_Poverty = evt.graphic.attributes.Demographics_Comparison__APC__3;
        At_Above_Poverty = evt.graphic.attributes.Demographics_Comparison__APC__4;
        Households = evt.graphic.attributes.Demographics_Comparison__APC__5;
        Households_with_2_People = evt.graphic.attributes.Demographics_Comparison__APC__6;
        Households_with_3_People = evt.graphic.attributes.Demographics_Comparison__APC__7;
        Households_with_4_People = evt.graphic.attributes.Demographics_Comparison__APC__8;
        Households_with_5_People = evt.graphic.attributes.Demographics_Comparison__APC__9;
        Households_with_6_People = evt.graphic.attributes.Demographics_Comparison__APC_10;
        Households_with_7_People = evt.graphic.attributes.Demographics_Comparison__APC_11;
        Nonfamily_Households = evt.graphic.attributes.Demographics_Comparison__APC_12;
        Enrolled_Nursery_Preschool = evt.graphic.attributes.Demographics_Comparison__APC_13;
        Enrolled_Kindergarten = evt.graphic.attributes.Demographics_Comparison__APC_14;
        Enrolled_Grade_1_4 = evt.graphic.attributes.Demographics_Comparison__APC_15;
        Enrolled_Grade_5_8 = evt.graphic.attributes.Demographics_Comparison__APC_16;
        Enrolled_Grade_9_12 = evt.graphic.attributes.Demographics_Comparison__APC_17;
        Enrolled_College = evt.graphic.attributes.Demographics_Comparison__APC_18;
        Enrolled_Grad_Professional_School = evt.graphic.attributes.Demographics_Comparison__APC_19;
        Not_Enrolled = evt.graphic.attributes.Demographics_Comparison__APC_20;
    ...
    function sendToChart() {
        ...
        load_own_rent_bar(data, "own_rent_bar-apc");
        ...
        load_donut(data, "poverty_donut-apc");
        ...
        data["labels"] = ["Enrolled in Kindergarten",
         ...
         load_donut(data, "education_donut-apc");
         ...
         load_donut(data, "household_donut-apc");
    }
